...
import { useAddUserMutation } from "@/app/lib/redux/api/adminApi";
...
export default function AddUserForm({ onClose }: { onClose: () => void }) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setErrors({ general: error.data?.error || "Failed to add user" });
    }
  };
        ...
        <div >
          ...
          <div className="relative">
            <input
                ...
                onChange={handleChange}
                className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 pr-10 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 relative"
            />
                  <button
            type="button"
